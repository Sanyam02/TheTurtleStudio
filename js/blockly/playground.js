...
function setOnOffLine() {
    ...
    if (location.protocol === 'file:') {
        document.body.style.backgroundColor = '#8ACC17';
        document.getElementById('CLI_content').style.backgroundColor = '#800561';
        document.getElementById('setup_content').style.backgroundColor = '#800561';
